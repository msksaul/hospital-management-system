    ...
    <div className='w-full p-4 flex flex-col justify-between gap-4 bg-white overflow-y-scroll min-h-full'>
      <div>
        <div className='flex items-center justify-center lg:justify-start gap-2'>
          ...
          <Link href={'/'} className='hidden lg:flex text-base 2xl:text-xl font-bold'>Kinda HMS</Link>
        </div>
            ...
            <div key={el.label} className='flex flex-col gap-2'>
              ...
              {el.links.map((link) => {
                if(link.access.includes(role.toLowerCase())) {
                  return (
                    <Link key={link.name} href={link.href} className='flex items-center justify-center lg:justify-start gap-4 text-gray-500 py-2 md:px-2 rounded-md hover:bg-blue-600/10'>
